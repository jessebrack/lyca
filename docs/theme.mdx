...
Design tokens are the smallest elements of your design system. When composed together, they inform how your primitive UI elements will look and behave.

You house your design tokens in your theme provider and pass it into the system via your `themeProvider`.
